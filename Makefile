# This Makefile is for the Eixo::Base extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Eixo/Base.pm]
#     AUTHOR => [q[frmadem <frmadem@>]]
#     BUILD_REQUIRES => {  }
#     NAME => q[Eixo::Base]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Eixo/Base.pm]
...
TO_INST_PM = lib/Eixo/Base.pm \
	lib/Eixo/Base/Clase.pm \
	lib/Eixo/Base/Util.pm

PM_TO_BLIB = lib/Eixo/Base.pm \
	blib/lib/Eixo/Base.pm \
	lib/Eixo/Base/Util.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  lib/Eixo/Base.pm $(INST_MAN3DIR)/Eixo::Base.$(MAN3EXT) 
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>frmadem &lt;frmadem@&gt;</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/Eixo/Base.pm blib/lib/Eixo/Base.pm \
	  lib/Eixo/Base/Util.pm blib/lib/Eixo/Base/Util.pm \
	  lib/Eixo/Base/Clase.pm blib/lib/Eixo/Base/Clase.pm 
